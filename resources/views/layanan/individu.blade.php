...
<head>
    ...
    <title>Layanan Individu - Bank Syariah Indonesia</title>
...
<body class="antialiased">
    ...
    <div id="produk" class="py-16">
        <div class="container mx-auto px-4">
            {{-- <h2 class="text-3xl font-bold text-center mb-12">Produk Unggulan</h2>s --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="relative w-full h-50 mb-6 rounded-lg overflow-hidden">
                        <img src="img/individu/emas.jpg" alt="emas" class="w-full h-full object-cover">
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="relative w-full h-50 mb-6 rounded-lg overflow-hidden">
                        <img src="img/individu/jasa.jpg" alt="jasa" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-white/100 to-transparent"></div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="relative w-full h-50 mb-6 rounded-lg overflow-hidden">
                        <img src="img/individu/haji.jpg" alt="haji&umrah" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-white/100 to-transparent"></div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="relative w-full h-50 mb-6 rounded-lg overflow-hidden">
                        <img src="img/individu/inves.jpg" alt="Investasi" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-white/100 to-transparent"></div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="relative w-full h-50 mb-6 rounded-lg overflow-hidden">
                        <img src="img/individu/biaya.jpg" alt="Pembiayaan" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-white/100 to-transparent"></div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="relative w-full h-50 mb-6 rounded-lg overflow-hidden">
                        <img src="img/individu/tabungan.jpg" alt="Tabungan" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-white/100 to-transparent"></div>
                    </div>
