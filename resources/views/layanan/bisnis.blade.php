        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <p class="texl-sm p-6 space-y-2 text-gray-600"> Layanan terintegrasi layanan Cash Management, Value
                        Chain, dan Trade Finance* dalam satu "klik"</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <p class="space-y-2 text-gray-600 text-sm p-6">
                        Tabungan dalam mata uang rupiah yang ditujukan untuk para wirausahawan.Tabungan ini menawarkan
                        berbagai kemudahan, seperti limit transaksi besar, gratis biaya transfer, dan mutasi rekening
                        yang informatif.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <p class="space-y-2 text-gray-600 text-sm p-6">
                        Pembiayaan yang disediakan oleh Bank Syariah Indonesia (BSI) untuk memenuhi kebutuhan modal
                        kerja, investasi, dan konsumtif pelaku usaha mikro, kecil, dan menengah (UMKM).
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <p class="space-y-2 text-gray-600 text-sm p-6">
                        Layanan online dari Bank Syariah Indonesia (BSI) yang memfasilitasi transaksi value chain.Value
                        chain adalah model bisnis yang menggambarkan bagaimana perusahaan menciptakan nilai bagi
                        pelanggannya.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <p class="space-y-2 text-gray-600 text-sm p-6">
                        Layanan yang disediakan oleh Bank Syariah Indonesia (BSI) untuk mendukung transaksi
                        perdagangan.Layanan ini meliputi penerbitan Letter of Credit (LC), Bank Garansi (BG), dan
                ...
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <p class="space-y-2 text-gray-600 text-sm p-6">
                        Layanan perbankan online dari Bank Syariah Indonesia (BSI) untuk nasabah non-perorangan. Layanan
                        ini memungkinkan nasabah untuk mengelola keuangan, melakukan transaksi harian, dan mengontrol
                        arus kas
                    </p>
                </div>
            </div>
