...
<body class="antialiased">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        @else
                            <a href="{{ route('register') }}" class="flex items-center space-x-2 border-2 border-emerald-500 text-emerald-500 hover:bg-emerald-50 px-6 py-2 rounded-lg transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                                </svg>
                                <span>Register</span>
                            </a>
                            <a href="{{ route('login') }}" class="flex items-center space-x-2 bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded-lg transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="relative h-[500px] overflow-hidden">
            ...
            <div class="absolute inset-0 transition-opacity duration-500" x-show="activeSlide === 1"
                ...
                <div class="absolute inset-0 flex flex-col justify-center px-20 ">
                    ...
                    <p class="text-xl max-w-2xl text-[#48a39e] mt-4">Nikmati berbagai layanan perbankan terbaik kami
                        yang dirancang khusus untuk memenuhi kebutuhan finansial Anda</p>
                </div>
            </div>
            <!-- Slide 2 -->
    ...
    <div class="fixed right-6 top-1/2 transform -translate-y-1/2 z-50 space-y-4">
        <button
            class="w-12 h-12 bg-yellow-500 hover:bg-blue-900 rounded-full flex items-center justify-center text-white shadow-lg transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">"Pelayanan sangat memuaskan dan sesuai dengan prinsip syariah. Sangat membantu dalam mengembangkan usaha saya."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">"Digital banking BSI sangat memudahkan saya dalam bertransaksi. Aplikasinya user-friendly dan aman."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">"Proses pengajuan pembiayaan cepat dan mudah. Staff sangat membantu dalam menjelaskan produk-produk yang sesuai kebutuhan."</p>
                </div>
            </div>
        </div>
    </section>
